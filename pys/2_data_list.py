...
def list_intro():
    ...
    clist = ['apple', 'orange', 'grape', 'strawberry']
    print(clist[2:3])  # grape
    # Assigning a slice can also modify original list, even clear the list
    clist[2:3] = ['grape']
    print(clist)  # ['apple', 'orange', 'grape', 'strawberry']
    clist[3:] = []
    print(clist)  # ['apple', 'orange', 'grape']
    clist[:] = []
    print(clist)  # []
    # List has many useful APIs
    clist.append('banana')
    clist[len(clist):] = ['peach']
    print(clist)
    # List elements can be duplicated, and None
...
def list_shallow_copy():
    ...
    # slice will return a shallow copy of a list
    rgba_correct = rgba[:]
