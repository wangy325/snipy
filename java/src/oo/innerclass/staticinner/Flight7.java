package oo.innerclass.staticinner;
...
class StaticFlight {
    ...
    static class InnerDest implements Dest {
        ...
        static AnotherLevel anotherLevel() {
            return new AnotherLevel();
        }

    }

    static InnerComp comp() {
        return new InnerComp();
    }

    static InnerDest dest(String s) {
 ...
 * StaticFlight.InnerDest.AnotherLevel.p(): 1
 */